...
VALUES (NEXT VALUE FOR TDS_SQ_MERCADO, 'Meia Cano Alto Algodao', 'Meia', 'Vestuario', 'M', 19.90);

INSERT INTO TDS_TB_MERCADO (ID, NOME, TIPO, SETOR, TAMANHO, PRECO)
VALUES (NEXT VALUE FOR TDS_SQ_MERCADO, 'Detergente Neutro', 'Produto de Limpeza', 'Limpeza', '500ml', 3.49);
